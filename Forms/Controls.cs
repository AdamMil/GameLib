...
{ public Label() { }
  ...
  { base.OnPaint(e);
    ...
    if(Image!=null)
    { Point at = UIHelpers.CalculateAlignment(rect, new Size(Image.Width, Image.Height), ImageAlign);
...
{ 
  ...
  { base.OnPaintBackground(e);
    UIHelpers.DrawBorder(e.Surface, DrawRect, BorderStyle, Focused ? ForeColor : BorderColor,
...
{ public CheckBox()
  ...
  protected internal override void OnPaintBackground(PaintEventArgs e)
  { base.OnPaintBackground(e);
    if(Focused) UIHelpers.DrawBorder(e.Surface, DrawRect, BorderStyle.Fixed3D, BorderColor, false);
  }
  ...
  { base.OnPaint(e);
    ...
    bool right = UIHelpers.AlignedRight(TextAlign);
    ContentAlignment align = UIHelpers.AlignedTop(TextAlign)    ? ContentAlignment.TopLeft    :
    ...
    UIHelpers.DrawBorder(e.Surface, box, BorderStyle, BorderColor, true);
    box.Inflate(-borderSize, -borderSize);
    e.Surface.Fill(box, !down && Enabled ? SystemColors.Window : SystemColors.Control);
    if(Checked) UIHelpers.DrawCheck(e.Surface, box.X+1, box.Y+1, SystemColors.ControlText);
  ...
  { if(UIHelpers.AlignedCenter(TextAlign))
...
{ public ScrollBar()
  ...
  { base.OnPaint(e);
    ...
    UIHelpers.DrawBorder(e.Surface, rect, BorderStyle.FixedThick, ForeColor, false);
  }
  ...
  { UIHelpers.DrawArrowBox(surface, rect,
                         place==Place.Up ? Horizontal ? UIHelpers.Arrow.Right : UIHelpers.Arrow.Down
                                         : Horizontal ? UIHelpers.Arrow.Left  : UIHelpers.Arrow.Up,
...
{ public ComboBox() { }
  ...
  protected internal override void OnPaint(PaintEventArgs e)
  { base.OnPaint(e);
    UIHelpers.DrawArrowBox(e.Surface, WindowToDisplay(BoxRect), UIHelpers.Arrow.Down, BoxRect.Width/4, down,
  ...
  { base.OnPaintBackground(e);
    ...
    { if(button.Area.IntersectsWith(e.WindowRect))
      { if(button.State!=ButtonState.Normal) // TODO: make this border style/color configurable
          UIHelpers.DrawBorder(e.Surface, WindowToDisplay(button.Area), BorderStyle.Fixed3D, BackColor, false);
      }
    }
  }
