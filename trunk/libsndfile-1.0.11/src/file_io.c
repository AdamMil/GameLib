...
static int GL_CALLCONV
psf_fclose_ (SF_PRIVATE *psf)
{	int retval ;
...
int
psf_open_rsrc_ (SF_PRIVATE *psf, int open_mode)
{	char *fname ;
...
static sf_count_t GL_CALLCONV
psf_get_filelen_ (SF_PRIVATE *psf)
{	sf_count_t	filelen ;
...
static sf_count_t GL_CALLCONV
psf_fseek_ (SF_PRIVATE *psf, sf_count_t offset, int whence)
...
static sf_count_t GL_CALLCONV
psf_fread_ (SF_PRIVATE *psf, void *ptr, sf_count_t bytes, sf_count_t items)
{	sf_count_t total = 0 ;
	ssize_t	count ;
...
static sf_count_t GL_CALLCONV
psf_fwrite_ (SF_PRIVATE *psf, const void *ptr, sf_count_t bytes, sf_count_t items)
{	sf_count_t total = 0 ;
	ssize_t	count ;
...
static sf_count_t GL_CALLCONV
psf_fgets_ (SF_PRIVATE *psf, char *buffer, sf_count_t bufsize)
{	sf_count_t	k = 0 ;
	sf_count_t		count ;
...
static int GL_CALLCONV
psf_ftruncate_ (SF_PRIVATE *psf, sf_count_t len)
{	int retval ;
...
/* Win32 */ static sf_count_t GL_CALLCONV
psf_fseek_ (SF_PRIVATE *psf, sf_count_t offset, int whence)
{	sf_count_t new_position ;
...
#else
#error Old win32 interface is unsupported
