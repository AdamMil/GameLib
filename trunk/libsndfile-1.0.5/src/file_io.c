...
static sf_count_t CALLCONV
psf_fwrite_ (SF_PRIVATE *psf, void *ptr, sf_count_t bytes, sf_count_t items)
{	sf_count_t total = 0 ;
	ssize_t	count ;
...
/* Win32 */ static sf_count_t CALLCONV
psf_fseek_ (SF_PRIVATE *psf, sf_count_t offset, int whence)
{	sf_count_t	new_position ;
...
{ psf_fseek_, psf_fread_, psf_fwrite_, psf_ftell_, psf_fgets_, psf_get_filelen_, psf_ftruncate_, psf_fclose_
};
