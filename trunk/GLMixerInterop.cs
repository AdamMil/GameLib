...
internal class GLMixer
{
  [CallConvCdecl] public unsafe delegate void MixCallback(int* stream, uint samples, IntPtr context);
  ...
  public static extern int GetFormat(out uint freq, out ushort format, out byte channels, out uint bufferBytes);
  ...
  public static extern ushort GetMixVolume();
