...
internal static class TTF
{
  ...
  public unsafe static extern SDL.SDL.Surface* RenderUNICODE_Solid(IntPtr font, string text, Color fg);
  ...
  public unsafe static extern SDL.SDL.Surface* RenderGlyph_Solid(IntPtr font, char ch, Color fg);
  ...
  public unsafe static extern SDL.SDL.Surface* RenderUNICODE_Shaded(IntPtr font, string text, Color fg, Color bg);
  ...
  public unsafe static extern SDL.SDL.Surface* RenderGlyph_Shaded(IntPtr font, char ch, Color fg, Color bg);
  ...
  public unsafe static extern SDL.SDL.Surface* RenderUNICODE_Blended(IntPtr font, string text, Color fg);
  ...
  public unsafe static extern SDL.SDL.Surface* RenderGlyph_Blended(IntPtr font, char ch, Color fg);
  #endregion
