...
public static unsafe class Shapes
{
  ...
  {
    Check(GFX.pixelRGBA(dest.surface, (short)x, (short)y, color.R, color.G, color.B, color.Alpha));
  }
  ...
  {
    Check(GFX.hlineRGBA(dest.surface, (short)x1, (short)x2, (short)y, color.R, color.G, color.B, color.Alpha));
  }
  ...
  {
    Check(GFX.vlineRGBA(dest.surface, (short)x, (short)y1, (short)y2, color.R, color.G, color.B, color.Alpha));
  }
  ...
  {
    Check(GFX.lineRGBA(dest.surface, (short)x1, (short)y1, (short)x2, (short)y2, color.R, color.G, color.B, color.Alpha));
  }
  ...
  {
    Check(GFX.aalineRGBA(dest.surface, (short)x1, (short)y1, (short)x2, (short)y2, color.R, color.G, color.B, color.Alpha));
  }
  ...
  {
    Check(GFX.boxRGBA(dest.surface, (short)x1, (short)y1, (short)x2, (short)y2, color.R, color.G, color.B, color.Alpha));
  }
  ...
  {
    Check(GFX.circleRGBA(dest.surface, (short)x, (short)y, (short)radius, color.R, color.G, color.B, color.Alpha));
  }
  ...
  {
    Check(GFX.aacircleRGBA(dest.surface, (short)x, (short)y, (short)radius, color.R, color.G, color.B, color.Alpha));
  }
  ...
  {
    Check(GFX.filledCircleRGBA(dest.surface, (short)x, (short)y, (short)radius, color.R, color.G, color.B, color.Alpha));
  }
  ...
  public static void FilledPie(Surface dest, int x, int y, int radius, int startDegs, int endDegs, Color color)
  {
    Check(GFX.filledpieRGBA(dest.surface, (short)x, (short)y, (short)radius, (short)(startDegs%360),
                            (short)(endDegs%360), color.R, color.G, color.B, color.Alpha));
  }
  ...
  public static void Polygon(Surface dest, Point[] points, int index, int length, Color color)
  {
    ...
    Check(GFX.polygonRGBA(dest.surface, vx, vy, length, color.R, color.G, color.B, color.Alpha));
  }
  ...
  {
    Polygon(dest, points, 0, points.Length, new Color(color, alpha));
  }
  ...
  {
    Polygon(dest, points, index, length, new Color(color, alpha));
  }
  ...
  public static void PolygonAA(Surface dest, Point[] points, int index, int length, Color color)
  {
    ...
    Check(GFX.aapolygonRGBA(dest.surface, vx, vy, length, color.R, color.G, color.B, color.Alpha));
  }
  ...
  {
    PolygonAA(dest, points, 0, points.Length, new Color(color, alpha));
  }
  ...
  {
    PolygonAA(dest, points, index, length, new Color(color, alpha));
  }
  ...
  public static void FilledPolygon(Surface dest, Point[] points, int index, int length, Color color)
  {
    ...
    Check(GFX.filledPolygonRGBA(dest.surface, vx, vy, length, color.R, color.G, color.B, color.Alpha));
  }
  ...
  {
    FilledPolygon(dest, points, 0, points.Length, new Color(color, alpha));
  }
  ...
  {
    FilledPolygon(dest, points, index, length, new Color(color, alpha));
  }
  #endregion
  ...
  public static void Bezier(Surface dest, Point[] points, int index, int length, int steps, Color color)
  {
    ...
    Check(GFX.bezierRGBA(dest.surface, vx, vy, length, steps, color.R, color.G, color.B, color.Alpha));
  }
  ...
  {
    Bezier(dest, points, 0, points.Length, steps, new Color(color, alpha));
  }
  ...
  {
    Bezier(dest, points, index, length, steps, new Color(color, alpha));
  }
  #endregion
